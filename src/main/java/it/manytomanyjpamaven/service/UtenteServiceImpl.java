...
public class UtenteServiceImpl implements UtenteService {
	...
	public void rimuovi(Long idUtente) throws Exception {
		...
		try {
			...
			Utente nuovoUtenteDaEliminare = utenteDAO.findByIdFetchingRuoli(idUtente);

			if (!nuovoUtenteDaEliminare.getRuoli().isEmpty()) {
				throw new UtenteConRuoliAssociatiException(
						"Impossibile cancellare l'utente perchè associato con ruoli!");
			}
			utenteDAO.delete(nuovoUtenteDaEliminare);
